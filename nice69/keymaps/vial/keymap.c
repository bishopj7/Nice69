...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = LAYOUT(
        ...
        RESET, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_AUDIO_VOL_UP,
        _______, _______, _______,           _______,           _______,           _______, KC_AUDIO_VOL_DOWN, _______),
